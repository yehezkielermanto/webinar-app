...
$tanggal_sekarang = date("Y-m-d "); // echo $tanggal_sekarang ;
$event_empty = '<p class="text-center">Belum ada event yang kamu ikuti</p>'; // kalau event empty
...
// Apabil isi feedback maka otomatis Hadir Absen
